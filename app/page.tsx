    ...
    <>
      ...
      <header className="site-header"><div className="container nav">
        <a className="brand" href="/" aria-label="M/s Madhwendra Authorized Distributor BKT operated by MKS Concord LLP">
          <Image src="/images/bkt-logo.png" alt="BKT Tyres" width={170} height={116} className="bkt-logo" priority />
          <span className="brand-divider" />
          <Image src="/images/mks-group-logo.jpeg" alt="MKS logo" width={130} height={88} className="mks-logo" priority />
          <span className="brand-divider" />
      ...
      <section className="hero hero-v2">
        ...
        <div className="container hero-v2-content">
          <div className="hero-v2-copy">
            ...
            <p className="hero-v2-lead">Construction equipment, BKT Off-The-Road tyres, genuine spare parts, lubricants and field support for demanding worksites across Uttar Pradesh.</p>
            ...
            <div className="hero-v2-points"><span>01 / OTR TYRES</span><span>02 / EQUIPMENT</span><span>03 / SUPPORT</span></div>
          </div>
        ...
        <div className="hero-v2-bottom"><div className="container"><span>Construction Equipment</span><span>BKT OTR Tyres</span><span>Genuine OEM Parts</span><span>Machine Services</span><span>Volvoline Lubricants</span></div></div>
      </section>

      <section className="trust-strip" aria-label="Brands and product focus"><div className="container trust-strip-inner"><div className="trust-intro"><span>02 / BUSINESS ECOSYSTEM</span><strong>Equipment, tyres, parts & support</strong></div><div className="trust-brands"><div><b>BKT</b><span>OTR TYRES</span></div><div><b>TATA HITACHI</b><span>CONSTRUCTION EQUIPMENT</span></div><div><b>ESCORTS KUBOTA</b><span>CONSTRUCTION EQUIPMENT</span></div><div><b>SCHWING STETTER</b><span>CONCRETE EQUIPMENT</span></div><div><b>VOLVOLINE</b><span>LUBRICANTS</span></div></div></div></section>

      <section className="section about-section about-v2" id="about"><div className="container about-v2-head"><div><p className="section-kicker">03 / ABOUT MKS CONCORD LLP</p><h2>Built around the machines, people and work that keep projects moving.</h2></div><div className="about-v2-intro"><p><strong>MKS Concord LLP</strong>, established in 2020, is a construction-focused business serving customers across Uttar Pradesh.</p><p><strong>M/s Madhwendra Authorized Distributor BKT</strong> is the BKT OTR tyre distribution operation, supporting customers with tyre solutions alongside construction equipment, genuine OEM spare parts, machine services and Volvoline lubricants.</p></div></div><div className="container about-v2-panel"><div className="about-v2-statement"><span>OUR APPROACH</span><strong>Practical support for demanding worksites.</strong><p>We connect product knowledge with field support so customers can discuss their machine, tyre size, application and operating conditions with one team.</p><a href={`tel:+91${phone}`}>Talk to MKS →</a></div><div className="about-v2-metrics"><div><strong>2020</strong><span>Established</span></div><div><strong>UP</strong><span>Regional reach</span></div><div><strong>OTR</strong><span>Tyre focus</span></div><div><strong>05</strong><span>Core service areas</span></div></div></div><div className="container mks-card-grid">{mksServices.map(([num,title,text]) => <article className="mks-card" key={num}><span>{num}</span><h3>{title}</h3><p>{text}</p></article>)}</div></section>
